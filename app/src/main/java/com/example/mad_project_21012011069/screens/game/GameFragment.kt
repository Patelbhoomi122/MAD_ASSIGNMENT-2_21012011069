package com.example.mad_project_21012011069.screens.game
...
import com.example.mad_project_21012011069.Constants
import com.example.mad_project_21012011069.Question
import com.example.mad_project_21012011069.R
import com.example.mad_project_21012011069.databinding.FragmentGameBinding
    ...
    private fun answerView(mSelectedPosition: Int, drawableView: Int) {
        ...
        when (mSelectedPosition) {
            ...
            4->{
                ...
                binding.tvOptionFour.background = context?.let { ContextCompat.getDrawable(it, drawableView) }
